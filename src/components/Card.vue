...
<br>
<div class="name">Noah Sfez <br> sfz.noah@gmail.com <br> 06 99 51 05 91</div>
  </div>
</div>
...
.wave {
  ...
  margin-left: -50%;
  margin-top: -70%;
  background: linear-gradient(744deg,#5d40ff,var(--vt-c-blue-dark) 60%,var(--vt-c-blue-light))
}
