...
<template>
  <header>
    ...
    <div id="mySidenav" class="sidenav" :class="{ 'active': sidenavOpen }">
      ...
      <ul>
        ...
        <li><RouterLink to="/experience" class="linknav">Expériences</RouterLink></li>
        <li><RouterLink to="/contact" class="linknav">Contact</RouterLink></li>
      </ul>
    </div>
  ...
  <footer>
    <div>
      <h4>Contact</h4>
      <a href="mailto:sfz.noah@gmail.com" class="mail" target="_blank">sfz.noah@gmail.com</a>
      <p>06 99 51 05 91</p>
    </div>
